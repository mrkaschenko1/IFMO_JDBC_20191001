...
public class SqlQueries {
    ...
    //language=HSQLDB
    public String select02 = "SELECT * FROM EMPLOYEE WHERE LENGTH(lastname) < 6 ORDER BY lastname";
    ...
    //language=HSQLDB
    public String select05 = "SELECT EMPLOYEE.lastname, EMPLOYEE.salary, DEPARTMENT.name " +
                        "FROM EMPLOYEE INNER JOIN DEPARTMENT ON EMPLOYEE.department = DEPARTMENT.id";

    //Select all employees and corresponding department name if there is one.
    //Name column containing name of the department "depname".
    //language=HSQLDB
    public String select06 = "SELECT EMPLOYEE.lastname, EMPLOYEE.salary, DEPARTMENT.name AS depname " +
    ...
    //language=HSQLDB
    public String select10 = "SELECT Emp1.lastname AS employee, Emp2.lastname AS manager FROM EMPLOYEE EMP1 LEFT JOIN EMPLOYEE EMP2 ON EMP1.manager=EMP2.id";
